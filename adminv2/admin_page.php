...
<!--         <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="active"><i class="fa fa-gears"></i>&nbsp Home</li>
        <li><i class="fa fa-home"><a href="manage_houses.php"></i>&nbsp Manage Houses</a></li>
...
<!-- Default box -->
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Welcome to Housefinder&reg Admin Panel!</h3>
        ...
        <div class="box-body">
            Navigate our admin panel by clicking the menus on the sidebar
            <br>--<br>
            You can collapse the sidebar by clicking the <i>"3 line icon"</i> beside the website name
            <br>--<br>
            You can minimize the table by clicking the minimize button on the top-right side of the table
        </div>      
        <div class="box-footer">
          <b>Hi Admin <?php echo ucwords($_SESSION['username']) ?>!</b>
        </div>
        <!-- /.box-body -->
      </div>
      <!-- /.box -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="../index.php">Housefinder&reg</a></strong> All rights
    reserved.
  </footer>
