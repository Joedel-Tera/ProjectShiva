  ...
  <div class="content-wrapper">
	...
	<h1 id="txt"><?php echo(time()); ?></h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-users"></i>&nbsp Manage Agents</li>
...
?>     
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
	              ...
	              <?php $row['id']; ?>
	              <td><?php echo $row['first_name']; ?>&nbsp<?php echo $row['middle_name']; ?>&nbsp<?php echo $row['last_name']; ?></td>
	              <td><?php echo $row['age']; ?></td>
	              <td><?php echo $row['gender']; ?></td>
                <td><?php echo $row['contact_number']; ?></td>
	              <td><?php echo $row['email_info']; ?></td>
	              <?php echo "<td><a href ='agent_delete.php?id=$id', onclick='myFunction(); return false;'>Delete</a></td>"; ?>
