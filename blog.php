...
//{
//    header('Location: blog-logged-in.php');
//}
?>
<!-- banner -->
<br>
...
<div class="row">
  ...
  <!-- blog list -->
  <div class="row">
                            <div class="col-lg-4 col-sm-4 "><a href="blogdetail.php" class="thumbnail"><img src="images/nobody.jpg" alt="Registered Agent"></a></div>
