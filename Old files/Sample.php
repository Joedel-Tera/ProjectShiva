...
<head>
	...
	<style>
		...
		#map-canvas { position: absolute; top: 40px; bottom: 65px; left: 10px; right: 10px; height: 400px;width: 400px; }
...
<body>
	<div id="map-search">
		<input id="search-txt" type="text" value="Cavite, Philippines" maxlength="100">
